          ...
          <View style={styles.section}>
            ...
            <View style={styles.infoBox}>
              <Text style={styles.infoText}>
                ...
                affects how you feel, think, and perform. When you align your
                nutrition, movement, and lifestyle with these natural rhythms,
                you unlock your body's full potential. No more fighting fatigue
                or forcing productivity during low-energy phases. Instead, you
                work WITH your hormones for sustainable, lifelong wellness.
              </Text>
            </View>
          </View>
