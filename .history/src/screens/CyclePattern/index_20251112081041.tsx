          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={styles.toggleContainer}>
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  selected === 'irregular' && styles.selectedButton,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleText,
                    selected === 'irregular' && styles.selectedText,
                  ]}
                >
                  Irregular
                </Text>
              ...
              <TouchableOpacity
                style={[
                  styles.toggleButton,
                  selected === 'regular' && styles.selectedButton,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.toggleText,
                    selected === 'regular' && styles.selectedText,
                  ]}
                >
                  Regular
                </Text>
