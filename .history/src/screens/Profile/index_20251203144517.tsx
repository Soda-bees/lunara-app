    ...
    <SafeAreaView style={styles.mainContainer} edges={['top']}>
      ...
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity style={styles.profileHeaderButton}>
          <Image source={images.profileIcon} style={styles.profileHeaderIcon} />
    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.insightCard}>
          ...
          <Text style={styles.insightCardText}>
            You sleep 1.5 hours longer during your menstrual phase. Honor this
            rest.
          </Text>
        </View>
      </View>
    ...
    <View style={styles.tabContent}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.weightTrendCard}>
          ...
          <Text style={styles.weightTrendSubtitle}>Your progress over time</Text>
        ...
        <View style={styles.recentEntriesSection}>
          ...
          {[
            ...
            { weight: '150.3 lbs', date: 'Oct 20, 2025', note: 'Great progress!' },
        ...
        {[
          ...
          <View key={index} style={styles.activeTrackingItem}>
            ...
            <View style={styles.activeTrackingInfo}>
              ...
              <Text style={styles.activeTrackingFrequency}>{item.frequency}</Text>
            </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.currentChallengeCard}>
          <View style={styles.currentChallengeHeader}>
            <View>
              <Text style={styles.currentChallengeName}>21-Day Detox Reset</Text>
