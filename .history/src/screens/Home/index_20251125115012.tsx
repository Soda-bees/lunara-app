...
export default function Home() {
  ...
  const emojis = ['😄', '🙂', '😐', '😞'];
  const energyEmojis = [energizedEmoji, highEmoji, mediumEmoji];
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.container}>
          ...
          <View style={styles.row2}>
            {['Great', 'Good', 'Okay', 'Low'].map((mood, index) => (
              <TouchableOpacity key={index} style={styles.optionBox}>
                <Text style={styles.optionEmoji}>{emojis[index]}</Text>
                <Text style={styles.optionText}>{mood}</Text>
              </TouchableOpacity>
            ))}
          </View>

          <Text style={[styles.label, { marginTop: 16 }]}>Energy Level</Text>
          <View style={styles.row2}>
          ...
          <View style={styles.sleepRow}>
            <View>
              <Text style={styles.label}>Last night’s sleep</Text>
              <Text style={styles.subText}>8.5 Hours</Text>
            </View>
            <View style={styles.tagGreen}>
              <Text style={styles.tagText}>Great</Text>
            </View>
          </View>
