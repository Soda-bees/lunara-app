        ...
        <View style={styles.phaseBody}>
          ...
          <View style={styles.cyclePhaseCard}>
            ...
            <View style={styles.rowFull}>
              <Text style={styles.numberTextGradient}>
                8<Text style={styles.numberTextMedium}>/28</Text>
              </Text>
              <View style={styles.dayTextContainer}>
                <Text style={styles.textBlackMedium}>Day 8</Text>
              </View>
            </View>
            ...
            <View style={styles.rowFull}>
              <View>
                <Text style={styles.spacedText}>CURRENT PROGRESS</Text>
                <Text style={styles.numberTextMedium}>Luteal</Text>
              </View>
              <Image source={images.lutealIcon} style={styles.lutealIcon} />
            </View>

            <Text style={styles.textBlackMedium}>
