      ...
      <GradientWrapper variant="basic">
        <View style={styles.phaseBody}>
          ...
          <View style={styles.cyclePhaseCard}>
            ...
            <View style={styles.rowFull}>
              <View style={styles.rowBottom}>
                ...
                <Text style={[styles.numberTextMedium, { top: 8 }]}>/ 28</Text>
              </View>
          ...
          <View style={styles.thisPhaseDataContainer}>
            ...
            <View style={styles.section}>
              ...
              <View>
                ...
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                  <Text style={styles.textBlackNormal}>Strength training</Text>
                </View>
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                ...
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                  <Text style={styles.textBlackNormal}>Try new activities</Text>
                </View>
              </View>
            </View>
            <View style={styles.section}>
              ...
              <View>
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                  <Text style={styles.textBlackNormal}>Start new projects</Text>
                </View>
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                  <Text style={styles.textBlackNormal}>
                ...
                <View style={styles.row}>
                  ...
                  <Text style={styles.textBlackNormal}>Take on challenges</Text>
                </View>
                <View style={styles.row}>
                  <View style={styles.bulletPoint}></View>
                  <Text style={styles.textBlackNormal}>Think big and plan</Text>
                </View>
              </View>
            </View>
          </View>
          ...
          >
            <View style={styles.row}>
              <Image source={images.sparkle} style={styles.icon} />
              <Text style={styles.textBlackBold}>Understanding This Phase</Text>
            </View>
            <Text style={styles.textBlackSmall}>
              Rising estrogen brings mental clarity and physical energy. This is
              when you naturally feel most optimistic and capable. Use this
