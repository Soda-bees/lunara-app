...
const iconRadius = circleRadius - ICON_SIZE / 2 + screenWidth * 0.04;

const anglePositions = [0, 90, 180, 270]; // degrees
...
export default function RhythmAnimation() {
  ...
  const handlePress = async () => {
    navigation.navigate('YourStrengthTransition');
  };
    ...
    >
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.circleContainer}>
          ...
          <Text style={styles.heading}>Day 13th</Text>
          <Text style={styles.centerText}>Follicular Phase</Text>
        ...
        <View style={styles.textContainer}>
          <Text style={styles.forgotText}>Understanding your rhythm</Text>
          <Text style={styles.paraText}>
            Your body follows a natural cycle. We’ll ask a few questions to
            learn your unique pattern.
          </Text>
        </View>
